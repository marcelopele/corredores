const form = document.getElementById('formNewCorredor');
const fotoInput = document.getElementById('input_img_corredor');
...
const handleForm = async (event) => {
    ...
    document.getElementById("img_corredor").value = fotoCodif || "";
    form.submit();
};
